            ...
            <div class="relative mx-auto minfo__contentBox max-w-container xl:max-2xl:max-w-65rem">
                        ...
                        <div class="items-center gap-6 hero-content md:flex xl:gap-10">
                            <div class="text-content pt-7 lg:pt-8 max-lg:max-w-[30rem]">
                                <h1
                                    ...
                                    I Create The<br>
                                    <span class="text-theme">Online Environment</span>
                                </h1>
                                <p>
                                    As a <span class="font-medium text-black dark:text-white/90">Full-Stack Developer</span>, my area of expertise is developing custom features that are precisely matched to the requirements of every project.
                                </p>
                    ...
                    <div class="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl about-section lg:p-10 2xl:p-13">
                        ...
                        <div class="mt-7 md:mt-10 section-title">
                            ...
                            <p class="max-w-2xl mt-4 md:mt-6 subtitle">
                                Hi, My name is <span class="text-black dark:text-white">Muhammad Hashir Ali</span>. Back in 2020, I started using <span class="text-black dark:text-white"> HTML</span> to construct websites. I kept looking out of curiosity and found this field to have a lot of opportunities. I've been absorbed in many facets of web development ever since, so my skill set has been constantly developing.
                            </p>
                        </div>
                    ...
                    <div class="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
                        ...
                        <div class="mb-8 mt-7 md:my-10 section-title">
                            ...
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                My area of expertise is creating solutions that are specific to the demands of the user, putting impact and utility first. I carefully plan every project to improve user experiences and produce measurable outcomes, from conception to completion.
                            </p>
                        </div>
                        ...
                        <div class="grid gap-5 md:gap-6 service-card-wrapper sm:grid-cols-2 lg:gap-7 2xl:gap-8">
                            <div class="relative p-5 transition duration-300 border py-7 md:p-7 card-item group border-platinum dark:border-metalBlack rounded-2xl xl:p-8 2xl:p-10 hover:border-theme">
                                ...
                                <p>
                                    Designing and developing dynamic websites with beautiful designs and flawless functioning.
                                </p>
                            </div>
                            ...
                            <div
                                ...
                                <p>
                                    Developing flexible Android apps that are suited to your specific requirements and vision.
                                </p>
                            </div>
                            <div
                                class="relative p-5 transition duration-300 border py-7 md:p-7 card-item group border-platinum dark:border-metalBlack rounded-2xl xl:p-8 2xl:p-10 hover:border-theme">
                                ...
                                <p>
                                    Creating user-friendly UIs that enthrall users and improve their online experience.
                                </p>
                            </div>
                            <div
                                class="relative p-5 transition duration-300 border py-7 md:p-7 card-item group border-platinum dark:border-metalBlack rounded-2xl xl:p-8 2xl:p-10 hover:border-theme">
                                ...
                                <p>
                                    Promoting brand expansion with clever internet marketing and interesting content.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div data-scroll-index="3" id="skill"
                    ...
                    <div class="relative px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
                        ...
                        <div class="mb-8 mt-7 md:my-10 section-title">
                            ...
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                I am skilled in many different areas and assure quality at every stage of a project by combining my technical expertise with artistic flare.
                            </p>
                        </div>
                ...
                <div data-scroll-index="4" id="resume"
                    ...
                    <div class="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
                        ...
                        <div class="mb-8 mt-7 md:my-10 section-title">
                            ...
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                Look into my work history and the worthwhile experiences I've had working on different projects and responsibilities.
                            </p>
                        </div><!--./section-title-->
                        ...
                        <div class="mb-8 mt-7 md:my-10 section-title">
                            ...
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                Learn about my credentials and educational background, which emphasize my dedication to lifelong learning.
                            </p>
                        </div>
                ...
                $mysql = "
                    SELECT 
                        ...
                        p.description,
                        p.project_type,
                        (SELECT image_path FROM Images WHERE project_id = p.project_id LIMIT 1) AS main_image,
                        (SELECT technology_name FROM Technologies t
                            JOIN ProjectTechnologies pt ON t.technology_id = pt.technology_id
                            WHERE pt.project_id = p.project_id LIMIT 1) AS main_technology
                    FROM Projects p
                ...
                <div data-scroll-index="5" id="portfolio"
                    ...
                    <div class="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
                        ...
                        <div class="mt-5 mb-8 md:my-10 section-title">
                            ...
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                Enter my digital exhibition, where inspiration and execution meet, and peruse a portfolio full of originality and skill.
                            </p>
                        </div><!--./section-title-->
                        ...
                        <div class="portfolio_wrapper grid sm:grid-cols-2 gap-4 lg:gap-7.5">
                            ...
                            <div class="relative item md:col-span-1 z-1 group">
                                <a class='flex items-center justify-center p-3 overflow-hidden border md:p-4 rounded-xl border-platinum dark:border-greyBlack' href="project-single.php?id=<?php echo $row['project_id']; ?>">
                                    ...
                                    <div
                                        ...
                                        <span>
                                            <?php echo htmlspecialchars($row['main_technology']); ?>
                                        </span>
                                    </div>
                                </a>
                                <ul
                ...
                <div data-scroll-index="7" id="testimonial"
                    ...
                    <div class="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
                        ...
                        <div class="mt-5 mb-8 md:my-10 section-title">
                            ...
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                Listen closely to the people I've worked with; their statements convey a sense of quality, satisfaction, and trust.
                            </p>
                        </div><!--./section-title-->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="text-center slider-inner md:px-5">
                                                ...
                                                <?php for ($i = 0; $i < 5; $i++) {
                                                    if ($i < $rating) {
                                                        echo '<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M14.4391 5.35656L10.1019 4.65667C10.0073 4.64115 9.92204 4.58373 9.87552 4.49217L7.86898 0.579903C7.69686 0.241595 7.21151 0.241595 7.03784 0.579903L5.0313 4.49217C4.98788 4.57753 4.9057 4.64115 4.80491 4.65667L0.467749 5.35656C0.0878407 5.41864 -0.0563694 5.87799 0.211892 6.14802L3.31008 9.26728C3.37521 9.33556 3.41088 9.43178 3.39537 9.53265L2.72239 13.8763C2.66346 14.2581 3.05113 14.539 3.39382 14.3667L7.31385 12.3819C7.39914 12.3384 7.50148 12.3353 7.59297 12.3819L11.513 14.3667C11.8572 14.5405 12.2434 14.2566 12.186 13.8763L11.5146 9.54662C11.4944 9.44885 11.5223 9.34332 11.5983 9.26728L14.6949 6.14802C14.9632 5.87799 14.8159 5.41709 14.4391 5.35656Z" fill="rgb(255, 217, 102)" />
                                                        </svg>';
                                                    } else {
                                                        echo '<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M14.4391 5.35656L10.1019 4.65667C10.0073 4.64115 9.92204 4.58373 9.87552 4.49217L7.86898 0.579903C7.69686 0.241595 7.21151 0.241595 7.03784 0.579903L5.0313 4.49217C4.98788 4.57753 4.9057 4.64115 4.80491 4.65667L0.467749 5.35656C0.0878407 5.41864 -0.0563694 5.87799 0.211892 6.14802L3.31008 9.26728C3.37521 9.33556 3.41088 9.43178 3.39537 9.53265L2.72239 13.8763C2.66346 14.2581 3.05113 14.539 3.39382 14.3667L7.31385 12.3819C7.39914 12.3384 7.50148 12.3353 7.59297 12.3819L11.513 14.3667C11.8572 14.5405 12.2434 14.2566 12.186 13.8763L11.5146 9.54662C11.4944 9.44885 11.5223 9.34332 11.5983 9.26728L14.6949 6.14802C14.9632 5.87799 14.8159 5.41709 14.4391 5.35656Z" fill="#cccccc" />
                                                        </svg>';
                                                    }
                                                } ?>
                                            </div>
                                            ...
                                            <div class="mt-5 text-center author">
                                                <h6 class="text-lg font-medium text-black dark:text-white"><?php echo htmlspecialchars($testimonial['author_name']); ?></h6>
                                                <p class="text-sm"><?php echo htmlspecialchars($testimonial['designation']); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                    ...
                    <div class="px-5 py-8 bg-white dark:bg-nightBlack rounded-2xl contact-section lg:p-13">
                        ...
                        <div class="mb-10 mt-7 section-title">
                            ...
                            <p class="mt-3.5 md:mt-5 subtitle max-w-sectionTitle">
                                Let's make your idea a reality. Reach out to me now, and together, let's begin creating something truly remarkable.
                            </p>
                        </div><!--./section-title-->
                                ...
                                <ul class="space-y-6 md:space-y-10 2xl:space-y-12 contact-info">
                                    ...
                                    <li class="flex flex-wrap items-center gap-5">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm">m.hashirali2001@gmail.com</p>
                                        </div>
                                    </li>
                                    <li class="flex flex-wrap items-center gap-5">
                                        <div class="flex justify-center w-12 icon">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm">+(92) 316 6635 774</p>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="md:col-span-7">
                                <form id="contactForm" action="" method="POST" class="space-y-4">
                                    <div class="form-group">
                                        <input type="text" name="contactName" id="client__name" placeholder="Name"
                                            class="w-full p-5 text-sm outline-none h-13 focus:border-theme dark:focus:border-theme dark:placeholder:text-white/40"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" name="contactEmail" id="client_email" placeholder="E-Mail"
                                            class="w-full p-5 text-sm outline-none h-13 focus:border-theme dark:focus:border-theme dark:placeholder:text-white/40"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="contactMessage" placeholder="Message" rows="5"
...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'muhammad.hashir.ali.official@gmail.com';
            $mail->Password   = 'hashirnazimabad3';
            $mail->SMTPSecure = 'tls';
            $mail->Port       = 587;

            // Sender and recipient details
            $mail->setFrom('muhammad.hashir.ali.official@gmail.com', 'M Hashir Ali');
            $mail->addAddress($email, $name);

            // Email content
            $mail->isHTML(true);
            $mail->Subject = "Contact From my Portfolio";
            $mail->Body    = "
                <p><b>Name: </b>".$name."</p>
                <br>
                <p><b>Email: </b>".$email."</p>
