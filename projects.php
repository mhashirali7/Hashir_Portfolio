        ...
        <div class="max-lg:px-4">
            ...
            <div class="w-full mx-auto minfo__sidebar__wrapper xl:fixed xl:top-1/2 xl:left-4 2xl:left-14 xl:-translate-y-1/2 md:max-w-sidebar xl:max-2xl:max-w-xs z-999">
                ...
                <div class="p-3 mb-3 overflow-hidden minfo__sidebar bg-white dark:bg-nightBlack rounded-2xl">
                    <div class="mx-4 mt-12 text-center user-info lg:mx-6">
                        <a class='w-36 h-36 mb-2.5 block mx-auto border-6 border-platinum dark:border-[#2f2f2f] overflow-hidden rounded-full' href='index.php'>
                            <img 
                                ...
                                alt="Muhammad Hashir Ali"> <!--Image for Dark Version -->
                            <img 
                                src="assets/img/user.jpg"
                                class="dark:hidden w-full h-full rounded-full"
                                alt="Muhammad Hashir Ali"> <!--Image for Light Version -->
                        </a>
                        <h6 class="mb-1 text-lg font-semibold text-black dark:text-white name">Muhammad Hashir Ali</h6>
                        <div class="leading-none cd-headline clip is-full-width">
                            <h6 class="text-sm cd-words-wrapper designation text-theme after:!bg-theme">
                                <b class="font-normal is-visible">Full-Stack Web Developer</b>
                                <b class="font-normal is-visible">Full-Stack Android App Developer</b>
                                <b class="font-normal">UI/UX Designer</b>
                                <b class="font-normal">Digital Marketer</b>
                            </h6>
                        </div>
                    </div>
                    ...
                    <div class="px-4 py-5 lg:py-6 lg:px-6 rounded-2xl md:px-8 bg-flashWhite dark:bg-metalBlack">
                        ...
                        <div class="mt-6">
                            <a href="assets/Muhammad_Hashir_Ali-Resume.pdf" download target="_blank"
            ...
            <div class="relative mx-auto minfo__contentBox max-w-container xl:max-2xl:max-w-65rem">
                ...
                <div class="py-3.5 max-w-content xl:max-2xl:max-w-50rem max-xl:mx-auto xl:ml-auto">
                    ...
                    <div class="c-projects-det-main px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                        <div
                        ...
                        ?>
                        <!-- Project Card -->
                        <div class="c-project-card d-flex px-4 py-2 border border-platinum dark:border-greyBlack200 rounded-2xl">
                            <div class="c-project-img mb-4 overflow-hidden mt-7 xl:my-8 thumb rounded-xl xl:rounded-2xl">
                                <?php foreach ($images as $image) { ?>
                                    <img src="<?php echo htmlspecialchars($image); ?>" class="w-full" alt="Project Thumbnail Image">
                                <?php } ?>
                            </div>
                            ...
                            <div class="c-content-sec">
                                <h2 class="text-2xl font-semibold leading-normal text-black dark:text-white mt-7 lg:mt-10 article-title lg:text-3xl lg:leading-normal">
                                    <a href="project-single.php?id=<?php echo $row['project_id']; ?>"><?php echo htmlspecialchars($row['project_name']); ?></a>
                                </h2>
                                <h3>
                                ...
                                <div>
                                    <p class="text-regular !leading-[2]">
                                        ...
                                        $word_limit = 20; // Set your word limit here

                                        $words = explode(' ', $description);
                                        if (count($words) > $word_limit) {
                                            $limited_description = implode(' ', array_slice($words, 0, $word_limit)) . '...';
                                        } else {
                                ...
                                <div class="post-meta sm:flex items-center justify-between my-8 mb-10 max-sm:space-y-3.5">
                                    <div>
                                        ...
                                        <p class="text-regular"><?php echo htmlspecialchars($row['client']); ?></p>
                                    </div>
                                    <div>
                ...
                <footer class="py-6 text-center lg:ml-auto footer-section max-w-content xl:max-2xl:max-w-50rem">
                    <p class="">
                        Copyright by
                        <a href="#" class="transition-colors">@hashir.com</a>
                    </p>
                </footer>
                <!-- Footer End -->
            </div>
...
<!-- Mirrored from minfotailwind.netlify.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Feb 2024 21:52:07 GMT -->
</html>